...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    public JwtAuthenticationFilter(JwtService jwtService, UserDetailsServiceSecurityImp detailsServiceSecurityImp) {
		super();
    ...
    protected void doFilterInternal(
        ...
        if(username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            UserDetails userDetails = detailsServiceSecurityImp.loadUserByUsername(username);
